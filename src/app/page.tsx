...
const Home: React.FC = () => {
  ...
  const fadeInVariants = {
    hidden: { opacity: 0 },
    visible: { opacity: 1, transition: { duration: 1.2, ease: [0.42, 0, 0.58, 1] as const } },
  };
  ...
  return (
    <div className="flex flex-col min-h-screen bg-black text-ivory overflow-x-hidden">
      ...
      >
        ...
        >
          <motion.h1 className="text-7xl md:text-9xl font-bold mb-6 serif leading-tight" variants={textRevealVariants}>
            <span className="block text-gold">Artistry in Every Fiber</span>
            <span className="block">Los Gatos' Premier Rug Restoration</span>
          </motion.h1>
          <motion.p className="text-2xl md:text-3xl mb-10 font-sans leading-relaxed" variants={textRevealVariants}>
      ...
      <main className="container mx-auto px-4 py-24">
        ...
        >
          <motion.h2 variants={textRevealVariants} className="text-6xl serif text-gold mb-10 leading-tight">
            Crafting Legacies, One Fiber at a Time
          </motion.h2>
          <motion.p variants={itemVariants} className="text-2xl font-sans text-ivory leading-relaxed max-w-4xl mx-auto opacity-90">
        ...
        >
          <motion.h2 variants={textRevealVariants} className="text-6xl serif text-gold mb-12 text-center leading-tight">
            Discover Your Rug in New Dimensions
          </motion.h2>
          <motion.p variants={itemVariants} className="text-xl font-sans text-ivory mb-12 max-w-3xl text-center opacity-80">
        ...
        <motion.section
          ...
          className="py-24"
        >
          <motion.h2 variants={textRevealVariants} className="text-6xl serif text-center text-gold mb-16 leading-tight">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <motion.div variants={itemVariants} className="aspect-video relative rounded-xl shadow-2xl overflow-hidden">
              <iframe
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 text-center">
            <motion.div variants={itemVariants} className="glass p-8 rounded-2xl shadow-xl hover:shadow-gold-light transition-shadow duration-300">
        ...
        >
          <div className="max-w-3xl mx-auto glass p-10 rounded-3xl shadow-2xl border border-gold-light border-opacity-20">
            <motion.h2 variants={textRevealVariants} className="text-6xl serif text-center text-gold mb-12 leading-tight">
              Your Private Concierge Desk
            </motion.h2>
            <motion.p variants={itemVariants} className="text-center text-ivory text-xl mb-12 font-sans opacity-90">
